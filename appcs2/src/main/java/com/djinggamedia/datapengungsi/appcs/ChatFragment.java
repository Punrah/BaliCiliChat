...
import com.djinggamedia.datapengungsi.appcs.adapter.ChatAdapter;
import com.djinggamedia.datapengungsi.appcs.app.CustomComparator;
...
public class ChatFragment extends Fragment {
    ...
    {
        mAdapter = new ChatAdapter(getActivity(),listItem);
        ...
        final String pesan;
            ...
            mDatabase.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    fetch();
                    if(listItem.size()!=0) {
                        displayNotification(listItem.get(0).getLastChat());
                    }
                }
