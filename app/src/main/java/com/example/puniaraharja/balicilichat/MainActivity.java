...
import com.example.puniaraharja.balicilichat.adapter.CustomViewPager;
...
tabAdapter(position);
    ...
    public void onPageScrollStateChanged(int state) {
        ...
        icon4.setImageResource(R.drawable.product);
        icon5.setImageResource(R.drawable.settings);
    ...
    private void tabAdapter(int no)
    {
        ...
        if(no==0)
        {
            ...
            text5.setTextColor(Color.parseColor("#cccccc"));
        }
        else  if(no==1)
        {
            icon1.setImageResource(R.drawable.contact);
        ...
        else  if(no==3)
        {
            ...
            icon2.setImageResource(R.drawable.chat);
            icon3.setImageResource(R.drawable.event);
            icon4.setImageResource(R.drawable.product_active);
            icon5.setImageResource(R.drawable.settings);
            text1.setTextColor(Color.parseColor("#cccccc"));
            text2.setTextColor(Color.parseColor("#cccccc"));
            text3.setTextColor(Color.parseColor("#cccccc"));
        ...
        else  if(no==4)
        {
            ...
            icon3.setImageResource(R.drawable.event);
            icon4.setImageResource(R.drawable.product);
            icon5.setImageResource(R.drawable.settings_active);
            text1.setTextColor(Color.parseColor("#cccccc"));
            text2.setTextColor(Color.parseColor("#cccccc"));
            text3.setTextColor(Color.parseColor("#cccccc"));
            text4.setTextColor(Color.parseColor("#cccccc"));
            text5.setTextColor(Color.parseColor("#ff9c3a"));
        }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        if(UserGlobal.getUser(this).status.contentEquals("cs"))
        {
            adapter.addFrag(new ChatFragmentCS(), "TWO");
        ...
        adapter.addFrag(new EventFragment(), "THREE");
        adapter.addFrag(new ProductFragment(), "FOUR");
